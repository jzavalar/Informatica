...
## Cómo está organizada cada semana

| Sesión del Proyecto | Qué Haces | IA |
|---|---|---|
| **1 · Modo Activista** | Te enfrentas al problema sin teoría previa | 🚫 |
| **2 · Modo Reflexivo** | Documentas, comparas, encuentras patrones | 🚫 |
| **3 · Modo Teórico** | Llega la lectura. Le pones nombre a lo que ya viste | ✅ |
| **4 · Laboratorio** | Resuelves en papel, ejecutas, verificas | ✅ |
| **5 · Modo Pragmático** | Entregas y sustentas por escrito | 🚫 |

La teoría llega tarde **a propósito**: es más fácil entender un concepto cuando ya chocaste con el fenómeno que nombra.

---

**Profesor:** dr. Jesús Zavala Ruiz · [jzr@xanum.uam.mx](mailto:jzr@xanum.uam.mx) · Telegram [@jzavalar](https://t.me/jzavalar)
