...
- *Práctica 4.4. Arquitectura de un sistemas de información*. (Entrega: 24 de enero de 2022).
  ...
  *Parte 4*. A continuación se pueden seguir dos caminos para preparar la infraestructura cliente-servidor para alojar aplicaciones empresariales.
   - El primer camino consiste en instalar la infraestructura (sistema operativo + servidor web + servidor de base de datos + lenguaje(s) de programación) en tres versiones: LAMP (**L**inux + **A**pache + **M**ySQL (o **M**ariaDB) + **P**HP), WAMP (**W**indows + **A**pache + **M**ySQL + **P**HP) o XAMPP (**X** (Linux o Windows) + **A**pache + **M**ariaDB + **P**HP + **P**erl)) y luego debe descargar e instalar la aplicación que se vaya a utilizar.
