...
Referencias:
   ...
   - Fedora.org (2022). Fedora Project. Fedora GNU/Linux [Software]. ([url](https://getfedora.org/es/)).
   ...
   - iDempiere (2022). iDempiere: Powerful, open-source ERP/CRM/SCM system. ([web](https://www.idempiere.org/)) ([software](https://www.idempiere.org/get-idempiere/)) ([sitos de prueba](https://www.idempiere.org/test-sites/)).
   ...
   - Snowden, E. (2019). *Permanent record*. London: Macmillan. ([epub](https://libgen.rs/book/index.php?md5=A5BDA164BB2B8419C57E57012A2F7F82)). (traducción: *Vigilancia permanente* [epub](https://libgen.rs/book/index.php?md5=5B91B59909B7CA93B0CD3F77BBA32864))
