...
El Internet y el teléfono, entre más inteligente y potente, es más intrusivo, abusivo y peligroso para la privacidad, salud y vida de sus usuarios, dando lugar a un fenómeno de *domesticación digital masivo*  analizado por el gurú de la realidad virtual, Jaron Lanier ([Ten Arguments for Deleting Your Social Media Accounts Right Now, 2010](https://libgen.rs/book/index.php?md5=F59013E7705F778979B3546A8A5453BC) (trad. [(Diez razones para borrar tus redes de inmediato, 2019b)](library.lol/main/CD2B81BCDAC2DF6FDA19FA9139801195)); 
[(You Are Not a Gadget: A Manifesto, 2018)](https://libgen.rs/book/index.php?md5=70421B703A5F553F126BA39C828BCC32) (trad. [Contra el rebaño digital](https://libgen.rs/book/index.php?md5=CD2B81BCDAC2DF6FDA19FA9139801195))). También ha quedado demostrado que las corporaciones multinacionales como Google, Facebook o Twitter vigilan, controlan y manipulan «algorítmicamente» el comportamiento de sus usuarios, sin escrúpulos y bajo contrato de particulares y gobiernos, tal como Cambridge Analytica y Facebook lo hicieron durante el proceso electoral en 2014, en Estados Unidos (cf. Kaiser (2019) [(Targeted)](https://libgen.rs/book/index.php?md5=1177B7414D7DA5E96BF2D1F0200027E1); Wylie (2019) [Mindf*ck](https://libgen.rs/book/index.php?md5=1BCE07AB1B741F54E9B706C671DD5B26)). Con el escándalo de la NSA, entre 2013 y 2015, quedó demostrado cómo, esas mismas corporaciones y las compañías telefónicas, facilitan la vigilancia y el espionaje global de sus usuarios por parte del Gobierno Norteamericano, a través de la US National Security Agency (NSA) (cf. [Snowden  (2019)](https://libgen.rs/book/index.php?md5=A5BDA164BB2B8419C57E57012A2F7F82) (trad. [Vigilancia permanente](https://libgen.rs/book/index.php?md5=5B91B59909B7CA93B0CD3F77BBA32864); [Greenwald and Snowden (2015)](https://libgen.rs/book/index.php?md5=18E90AA8AA171501DBEAB7F5C87E7AAB)).

Por otro lado, la brecha tecnológica, brecha digital (o *tech gap*) o *analfabetismo digital* es un serio obstáculo para el desarrollo de las personas pues las vuelve funcionalmente incapaces de usar correctamente las applicaciones, por ejemplo, en los cajeros automáticos y en sus teléfonos inteligentes; incluso, ese analfabetismo digital se considera un obstáculo laboral muy importante en las organizaciones. Esa brecha digital se incrementa día a día, cualitativa y cuantitativamente y, aunque intenta paliarse con los más jóvenes que enseñan a los más viejos. Incluso, para estos *kiddies* expertos en el manejo de aplicaciones, el *smartphone* y su funcionamiento sigue siendo un gran misterio, magnificado y oculto tras las "sofisticadas" aplicaciones o apps. Claramente, al dominio de la lengua materna, las matemáticas y los conocimientos científicos y sociales indispensables se han sumado el **idioma inglés** (y pronto lo será el chino mandarín) y la **informática** o **computación**. Las “otras ciencias”, como las matemáticas, las ciencias naturales (físicas, químicas y biológicas) y todas las ingenierías, hasta las ciencias sociales como la psicología, la sociología y la administración, pero también las artes y las humanidades están impactadas por la computación, que se ha convertido en una **transdisciplina** por mérito propio.

Esta **unidad de enseñanza-aprendizaje** (**UEA**) se incribe en el contexto de cubrir parte del plan de estudios (ya obsoleto) de la carrera de administración en la Universidad Autónoma Metropolitana, Unidad Iztapalapa, en la Ciudad de México, a ala vez que pretende reducir la brecha digital de los estudiantes. El **objetivo general** de este curso es proporcionar los **fundamentos teóricos** o conceptuales de las **"ciencias de la computación"** (**computer science**) (o, simplemente, "computación" (*computing*)) y de la **informática** entendida como la aplicación de la computación en la administración. Comienza con entender el modelo de la computadora personal
cualquier computadora personal, laptop, tableta o teléfono celular en su vida escolar y profesional, con eficacia y seguridad* con la idea de que resulte *menos vulnerable a la obsolescencia* por ser útil en el corto y largo plazo. Al mismo tiempo se pretende que los alumnos conozcan el panorama de los sistemas operativos, de las aplicaciones gratuitas y de los sistemas empresariales de software libre y abierto y que  valoren la importancia de la informática en su vida diaria, como profesionales de la administración, en las organizaciones, en general. El **enfoque pedagógico** de esta UEA es **teórico-práctico**; por un lado, se proponen *lecturas* de algunos capítulos del libro *Introducción a la ciencia de la computación: De la manlpulaclón de datos a la teoría de la computación* (Forouzan, 2003), como libro de texto base y se complementa con otros recursos didácticos. Por otro lado, de manera paralela se realizan algunas prácticas que permitirán aterrizar los conceptos y desarrollar habilidades para resolver problemas informáticos del día a día.

Citas:
   - Forouzan, B. A. (2003). *Introducción a la ciencia de la computación: De la manlpulaclón de datos a la teoría de la computación*. México: Thompson. ([url](https://libgen.rs/book/index.php?md5=79EEE336054F54078C999A7146CC522D).
   - Light, J. S. (1999). When computers were women. *Technology and Culture, 40*(3) (Jul.), 455-483. ([url](https://www.jstor.org/stable/25147356)) ([pdf](https://sci-hub.se/10.2307/25147356)).
   - Erickson, L. (2010). *Top secret rosies: The female computers of WWII*. ([url](http://www.topsecretrosies.com/) [torrent](https://thepiratebay.org/description.php?id=6804294)).
   - Melfi, T. (2016). *Talentos Ocultos* (*Hidden Figures*) ([url](https://www.imdb.com/title/tt4846340/)) ([torrent](https://thepiratebay.org/description.php?id=17551668)).
   - Lanier, J. (2018). *Ten arguments for deleting your social media Accounts right now*. New York: Henry Holt and Company ([epub](https://libgen.rs/book/index.php?md5=F59013E7705F778979B3546A8A5453BC)) (Traducción: *Diez razones para borrar tus redes de inmediato* (2019). [epub](https://libgen.rs/book/index.php?md5=EF2E847FE3A3DFB92CA1751CF26E3E99)).
   - Lanier, J. (2010). *You are not a gadget: A manifesto*. New York: Vintage Books. ([url](https://libgen.rs/book/index.php?md5=70421B703A5F553F126BA39C828BCC32) (Traducción: *Contra el rebaño digital* (2019). ([epub](https://libgen.rs/book/index.php?md5=CD2B81BCDAC2DF6FDA19FA9139801195))
   - UAM. Informática. [Programa vigente](http://csh.izt.uam.mx/sistemadivisional/SDIP/pac/2211088pe.pdf).
   - UAM. Calendario vigente. [url](http://www.uam.mx/calendario/index.html).
...
- Erickson, L. (2010). Top secret rosies: The female computers of WWII. [Sitio oficial](http://www.topsecretrosies.com/). [IMDb](https://www.imdb.com/title/tt1587359/). [YouTube](https://www.youtube.com/watch?v=gR4yzUnKn2U) [torrent]()). 
...
- *Práctica 1.1. Partes de la computadora*. (Entrega: 18 de julio de 2022).
...
- *Práctica 1.2. Funciones de la computadora*. (Entrega: 20 de julio de 2022).
...
- *Práctica 1.4. Historia de la computación: Parte 2*. (Entrega: 25 de julio de 2022).
...
- *Tarea 1.5. Conceptos fundamentales*. (Entrega: 27 de julio de 2022).
...
- *Práctica 1.6. Adquisición de una computadora*. (Entrega: 27 de julio de 2022).
...
- *Práctica 1.7. Encriptación*. (Opcional) (Entrega: 27 de julio de 2022).
...
- *Tarea 2.1. Conceptos básicos de software*. (Entrega: 1 de agosto de 2022).
...
- *Tarea 2.2. Licenciamiento de software*. (Entrega: 1 de agosto de 2022).
...
- *Práctica 2.3. Instalación de sistemas operativos en un medio extraible*. (Entrega: 3 de agosto de 2022).
...
- *Práctica 2.4. Instalación de sistemas operativos como máquinas virtuales*. (Entrega: 3 de agosto de 2022).
...
- *Práctica 2.5: Recuperación de archivos*. (Entrega: 8 de agosto de 2022).
...
- *Práctica 2.6. Particiones y sistemas de archivos*. (Entrega: 8 de agosto de 2022).
...
- *Práctica 2.7. Instalación de driver o controlador de hardware*. (Entrega: 8 de agosto de 2022).
...
- *Práctica 2.8. Comandos básicos de un sistema operativo y de manejo de archivos*. (Entrega: 10 de agosto de 2022).
...
- *Tarea 3.1. Desarrollo de software*. (Entrega: 15 de agosto de 2022).
...
- *Práctica 3.2. Algoritmos y pseudocódigo*. (Entrega: 15 de agosto de 2022).
...
- *Práctica 3.3. Programación Parte 1: Control básico, condicionales y ciclos*. (Entrega: 15 de agosto de 2022).
...
- *Práctica 3.4. Programación Parte 2: Diagramas de flujo*. (Entrega: 17 de agosto de 2022).
...
- *Práctica 3.5. Programación Parte 3: Contadores, arreglos y estructuras de datos*. (Entrega: 17 de agosto de 2022).
...
- *Práctica 3.6. Programación Parte 4: Funciones*. (Entrega: 22 de agosto de 2022).
...
- *Tarea 3.7. Ejercicios programación de algoritmos*. (Entrega: 22-24 de agosto de 2022). 
...
- Tecno Hobbies. (2018, Jan 11). [Curso de Pseint 2018](https://www.youtube.com/playlist?list=PLwOemaB2t99ZEIKLeoxdz91F9AKC-vkK7). *YouTube*. (31 videos).
- Programación en PseInt. [pdf](https://www.edu.xunta.gal/centros/iesblancoamorculleredo/aulavirtual/pluginfile.php/37189/mod_assign/intro/ApuntesPSEINT201617%20%281%29.pdf)
- LaTeX/Mathematics. Wikibooks. [url](https://en.wikibooks.org/wiki/LaTeX/Mathematics)
...
- Gil-Saura, R. (2021). [Tablas y graficos con R y R Studio](https://tables.investigaonline.com/). Investiga Online.
...
- *Práctica 5.1. Tablas dinámicas con hoja de cálculo*. (Entrega: ). 
...
- *Práctica 5.3. Presentaciones* (Entrega: )
...
- *Práctica 5.4. Base de datos geográfica*. (Entrega: ).
