...
**Trimestre:** 26 Primavera

**Grupo:** HA59 **Horario:** Lunes y Miércoles de 14:00 a 16:00 hr **Salón:** Anexo del Edificio A, Sala K (AA-K).  
...
- <img src="https://github.com/jzavalar/informatica/blob/main/images/telegram_logo.svg" alt="Telegram" width="3%"/> **Telegram:** Telegram: [https://t.me/jzavalar](https://t.me/jzavalar)
...
Hoy en día, ante lo ubícuo de las computadoras, casi olvidamos que un día, hace más de medio siglo, las computadoras eran humanas y femeninas (Light, 1999). En aquellos tiempos se les llamaba *calculistas* o *calculadoras* y eran las más brillantes matemáticas de su tiempo y su trabajo era secreto. Así lo ilustró la película *Top Secret Rosies: The Female Computers of WWII*. Años después, en plena Guerra Fría, las máquinas computadoras o simplemente **computadoras** ya jugaban un papel primordial, tal como Theodore Melfi (2016) lo ilustró en la película *Talentos Ocultos* (*Hidden Figures*). Hoy tenemos computadoras en todos lados, hasta en la cocina en los componentes electrónicos inteligentes añadidos a los distintos aparatos como el refrigerador, la cafetera o el horno de microondas. Sin embargo, el principal uso de las computadoras sigue siendo militar, científico, gubernamental y para los negocios controlando vehículos, fábricas, la cadena de suministros, las ventas, hasta alcanzar todas las áreas productivas y administrativas.

A principios de la década de 2010, las pantallas táctiles con unos cuantos botones de control y la tecnología de comunicaciones 4G con internet móvil, dieron paso a la masificación de la computadora más común en la actualidad: «teléfono inteligente» o *«smartphone»*. Los teléfonos se vuelven cada vez más pequeños y más «inteligentes» usados por usuarios cada vez "menos inteligentes". Hoy, el mundo transita hacia la 5G con la promesa del internet de altísima velocidad, en medio de una guerra por los chips entre Estados Unidos y China, sin precedentes. Las implicaciones sociales de la computarización de la sociedad actual son muchas y de gran envergadura: una creciente dependencia psicológica y funcional del *smartphone* y un incremento de la brecha tecnológica, *«tech gap»* o *analfabetismo computacional*, entre otras.
...
1. Utilizar *programas de aplicación general* para el manejo de *datos numéricos* y de *bases de datos* con el propósito de emplearlos como apoyo a las actividades propias de la carrera de administración.

2. Expresar la comprensión de textos y comunicar sus ideas haciendo un uso adecuado de la lengua española.

---

## Programa Analítico

> **Nota:** El programa analítico detallado con unidades, temas, subtemas y cronograma se encuentra disponible en el siguiente enlace:
> 
> 📄 [Programa Vigente UEA 2211088](http://csh.izt.uam.mx/sistemadivisional/SDIP/pac/2211088pe.pdf)
...
- Forouzan, B. A. (2003). [*Introducción a la ciencia de la computación: De la manipulación de datos a la teoría de la computación*](https://libgen.st/book/index.php?md5=79EEE336054F54078C999A7146CC522D). México: Thompson.

### Bibliografía Complementaria

- Erickson, L. (2010). [*Top secret rosies: The female computers of WWII*](http://www.topsecretrosies.com/). [video].

- Greenwald, G., & Snowden, E. J. (2015). [*No place to hide: Edward Snowden, the NSA and the surveillance state*](https://libgen.st/book/index.php?md5=18E90AA8AA171501DBEAB7F5C87E7AAB). United States: Penguin Books.

- Kaiser, B. (2019). *Cambridge Analytica and the manipulation of democratic processes*.

- Lanier, J. (2010). [*You are not a gadget: A manifesto*](https://libgen.st/book/index.php?md5=70421B703A5F553F126BA39C828BCC32). New York: Vintage Books. (Traducción: *Contra el rebaño digital*, 2019).

- Lanier, J. (2018). [*Ten arguments for deleting your social media accounts right now*](https://libgen.st/book/index.php?md5=F59013E7705F778979B3546A8A5453BC). New York: Henry Holt and Company. (Traducción: *Diez razones para borrar tus redes de inmediato*, 2019).

- Light, J. S. (1999). [When computers were women](https://www.jstor.org/stable/25147356). *Technology and Culture*, 40(3), 455-483.

- Melfi, T. (2016). [*Talentos Ocultos (Hidden Figures)*](https://www.imdb.com/title/tt4846340/).

- Snowden, E. (2019). [*Permanent record*](https://libgen.st/book/index.php?md5=A5BDA164BB2B8419C57E57012A2F7F82). London: Macmillan. (Traducción: *Vigilancia permanente*).

- Wylie, C. (2019). *Mindf*ck: Cambridge Analytica and the plot to break America*.

### Recursos Digitales

- [Fedora Project - GNU/Linux](https://getfedora.org/es/)
- [iDempiere - ERP System](https://www.idempiere.org/)
- [UAM - Calendario Vigente](http://www.uam.mx/calendario/index.html)

---

## Evaluación

La evaluación del curso se realizará conforme a lo establecido en el programa oficial de la UEA y el calendario académico vigente de la UAM.

---

## Recursos y Herramientas

Durante el curso se utilizarán las siguientes herramientas tecnológicas:

- **Sistema Operativo:** GNU/Linux Fedora (instalado en USB y/o Máquina Virtual)
- **Software de Productividad:** Herramientas de código abierto para manejo de datos y bases de datos
- **Plataforma de Comunicación:** Telegram para asesorías y comunicación asincrónica
- **Sistemas ERP:** iDempiere para prácticas empresariales

---

## Contacto y Soporte

Para dudas, comentarios o programación de asesorías:

- **Horario de atención:** Martes de 20:00 a 22:00 hr
- **Medio:** Telegram (previa programación)
- **Correo institucional:** [jzr@xanum.uam.mx](mailto:jzr@xanum.uam.mx)
