...
La fecha es un caso típico de un **tipo de dato complejo** porque se tiene *tres componentes*: la fecha, la hora y la marca de tiempo. Los componentes de una **fecha** (año, mes, día) pueden representarse en números enteros. 
